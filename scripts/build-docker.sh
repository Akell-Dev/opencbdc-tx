...
DOCKER_IMAGE_TAG_THREEPC=${DOCKER_IMAGE_TAG:-opencbdc-tx-threepc}
...
docker build --target threepc  --build-arg BASE_IMAGE=base -t $DOCKER_IMAGE_TAG_THREEPC  -f $SCRIPT_DIR/../Dockerfile $SCRIPT_DIR/..
